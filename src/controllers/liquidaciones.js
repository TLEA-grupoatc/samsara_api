                ...
                if(sinexpacio == req.params.unidad) {
                    ...
                    if(datosorder[i].DIAS > 13 && datosorder[i].DIAS <= 50) {
                        ...
                        let da = ({
                            ...
                            liquidadora: bitacoras != undefined ? bitacoras.liqui : '',
    ...
    async function obtenerBitacoras(operador, fecha, uni) {
        try {
            ...
            for(let index = 0; index < result['recordsets'][0].length; index++) {   
                kilos.push(result['recordsets'][0][index].total_kilometros1);   
            }
            ...
            if(uni == 'UNIDAD 1') {liq = 'ALMA-TLE'}
            if(uni == 'UNIDAD 2') {liq = 'CECILIA'}
            if(uni == 'UNIDAD 3') {liq = 'VICTORIA'}
            if(uni == 'UNIDAD 4') {liq = 'VANESA'}
            if(uni == 'UNIDAD 5') {liq = 'ALEJANDRA'}
