...
module.exports = app => {
    ...
    app.crearHistoricoCertificacion = (req, res) => {
        let body = req.body;

        let nuevoRegistro = new certificacionhistorico({
        ...
        certificacionhistorico.create(nuevoRegistro.dataValues, {
            fields: [
                'id_certificacion',
                'origen',
                'destino',
        ...
        .then(async result => {
            ...
            ruta.update(data.dataValues, {
                ...
                individualHooks: true, 
                fields: ['estatus', 'fecha_ultima_moficacion']
            }).then(result => {
                console.log('rows_affected' + result[0]);
            }).catch(err => {
